...
jitas_instruction_t jitas_instructions[] = {
	...
	{"imul", 1, {0xF6, 5}, JITAS_SIZE_BYTE, JITAS_ARG_NONE, JITAS_ARG_MODRM},
	{NULL, 1, {0xF7, 5}, JITAS_SIZE_ANY, JITAS_ARG_NONE, JITAS_ARG_MODRM},

	{"div", 1, {0xF6, 6}, JITAS_SIZE_BYTE, JITAS_ARG_NONE, JITAS_ARG_MODRM},
	{NULL, 1, {0xF7, 6}, JITAS_SIZE_ANY, JITAS_ARG_NONE, JITAS_ARG_MODRM},

	{"idiv", 1, {0xF6, 7}, JITAS_SIZE_BYTE, JITAS_ARG_NONE, JITAS_ARG_MODRM},
	{NULL, 1, {0xF7, 7}, JITAS_SIZE_ANY, JITAS_ARG_NONE, JITAS_ARG_MODRM},
	...
	{"not", 1, {0xF6, 2}, JITAS_SIZE_BYTE, JITAS_ARG_NONE, JITAS_ARG_MODRM},
	{NULL, 1, {0xF7, 2}, JITAS_SIZE_ANY, JITAS_ARG_NONE, JITAS_ARG_MODRM},

	{"and", 1, {0x24}, JITAS_SIZE_BYTE, JITAS_ARG_IMM, JITAS_ARG_REGA},
	{NULL, 1, {0x25}, JITAS_SIZE_ANY, JITAS_ARG_IMM_MAX32, JITAS_ARG_REGA},
	{NULL, 1, {0x80, 4}, JITAS_SIZE_BYTE, JITAS_ARG_IMM, JITAS_ARG_MODRM},
	{NULL, 1, {0x81, 4}, JITAS_SIZE_ANY, JITAS_ARG_IMM_MAX32, JITAS_ARG_MODRM},
	{NULL, 1, {0x83, 4}, JITAS_SIZE_ANY, JITAS_ARG_IMM8, JITAS_ARG_MODRM},
	{NULL, 1, {0x20}, JITAS_SIZE_BYTE, JITAS_ARG_REG, JITAS_ARG_MODRM},
	{NULL, 1, {0x21}, JITAS_SIZE_ANY, JITAS_ARG_REG, JITAS_ARG_MODRM},
	{NULL, 1, {0x22}, JITAS_SIZE_BYTE, JITAS_ARG_MODRM, JITAS_ARG_REG},
	{NULL, 1, {0x23}, JITAS_SIZE_ANY, JITAS_ARG_MODRM, JITAS_ARG_REG},

	{"or", 1, {0x0C}, JITAS_SIZE_BYTE, JITAS_ARG_IMM, JITAS_ARG_REGA},
	{NULL, 1, {0x0D}, JITAS_SIZE_ANY, JITAS_ARG_IMM_MAX32, JITAS_ARG_REGA},
	{NULL, 1, {0x80, 1}, JITAS_SIZE_BYTE, JITAS_ARG_IMM, JITAS_ARG_MODRM},
	{NULL, 1, {0x81, 1}, JITAS_SIZE_ANY, JITAS_ARG_IMM_MAX32, JITAS_ARG_MODRM},
	{NULL, 1, {0x83, 1}, JITAS_SIZE_ANY, JITAS_ARG_IMM8, JITAS_ARG_MODRM},
	{NULL, 1, {0x08}, JITAS_SIZE_BYTE, JITAS_ARG_REG, JITAS_ARG_MODRM},
	{NULL, 1, {0x09}, JITAS_SIZE_ANY, JITAS_ARG_REG, JITAS_ARG_MODRM},
	{NULL, 1, {0x0A}, JITAS_SIZE_BYTE, JITAS_ARG_MODRM, JITAS_ARG_REG},
	{NULL, 1, {0x0B}, JITAS_SIZE_ANY, JITAS_ARG_MODRM, JITAS_ARG_REG},

	{"xor", 1, {0x34}, JITAS_SIZE_BYTE, JITAS_ARG_IMM, JITAS_ARG_REGA},
	{NULL, 1, {0x35}, JITAS_SIZE_ANY, JITAS_ARG_IMM_MAX32, JITAS_ARG_REGA},
	{NULL, 1, {0x80, 6}, JITAS_SIZE_BYTE, JITAS_ARG_IMM, JITAS_ARG_MODRM},
	{NULL, 1, {0x81, 6}, JITAS_SIZE_ANY, JITAS_ARG_IMM_MAX32, JITAS_ARG_MODRM},
	{NULL, 1, {0x83, 6}, JITAS_SIZE_ANY, JITAS_ARG_IMM8, JITAS_ARG_MODRM},
	{NULL, 1, {0x30}, JITAS_SIZE_BYTE, JITAS_ARG_REG, JITAS_ARG_MODRM},
	...
	{"jmp", 1, {0xE9}, JITAS_SIZE_IGNORE, JITAS_ARG_NONE, JITAS_ARG_REL32},
	{NULL, 1, {0xFF, 4}, JITAS_SIZE_IGNORE, JITAS_ARG_NONE, JITAS_ARG_MODRM},
	//... far jmp
	...
	{"call", 1, {0xE8}, JITAS_SIZE_IGNORE, JITAS_ARG_NONE, JITAS_ARG_REL32},
	{NULL, 1, {0xFF, 2}, JITAS_SIZE_IGNORE, JITAS_ARG_NONE, JITAS_ARG_MODRM},
	//... far call

	{"ret", 1, {0xC3}, JITAS_SIZE_IGNORE, JITAS_ARG_NONE, JITAS_ARG_NONE},
	{NULL, 1, {0xC2}, JITAS_SIZE_IGNORE, JITAS_ARG_NONE, JITAS_ARG_IMM16},
	//... far ret
	...
	{"int3", 1, {0xCC}, JITAS_SIZE_IGNORE, JITAS_ARG_NONE, JITAS_ARG_NONE},
	{"int", 1, {0xCD}, JITAS_SIZE_IGNORE, JITAS_ARG_NONE, JITAS_ARG_IMM},

	{"sysenter", 2, {0x0F, 0x34}, JITAS_SIZE_IGNORE, JITAS_ARG_NONE, JITAS_ARG_NONE},
	{"syscall", 2, {0x0F, 0x05}, JITAS_SIZE_IGNORE, JITAS_ARG_NONE, JITAS_ARG_NONE},
};
